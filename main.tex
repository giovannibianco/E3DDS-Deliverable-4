...
In this scenario \EC EISCAT runs the high-priority services and outsources medium/low to their partners.
...
\end{tabular}
\caption{The Low and Medium-priority \einfra services run by partners in Scenario 3. \label{tab:services:s3a}}
\end{table}
\end{center}
...
\label{ssec:scen4}
 ...
 runs most, but outsources things with obvious synergies at other places (data archive, batch computing, web portals).

...
Scenario 5 is similar to Section~\ref{ssec:scen3} where
\EC EISCAT runs the high-priority services and outsources medium/low to their partners.
but NT1 operates EISCAT's inhouse resources under a service contract.
